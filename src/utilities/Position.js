...
class Position {
  ...
  possibleNonLosingMoves() {
    ...
    if (forcedMoves) {
      if ((forcedMoves & (forcedMoves - 1n)) !== 0n) return 0n
  ...
  top_mask_col(col) {
    ...
    // eslint-disable-next-line no-undef
    else return (1n << BigInt(this.height - 1)) << BigInt(col * (this.height + 1))
  }
  ...
  bottom_mask_col(col) {
    ...
    // eslint-disable-next-line no-undef
    else return 1n << BigInt(col * (this.height + 1))
  }
  ...
  column_mask(col) {
    ...
    // eslint-disable-next-line no-undef
    else return ((1n << BigInt(this.height)) - 1n) << BigInt(col * (this.height + 1))
  }
}
